package com.example.mygooglemapsactivityfromheck
...
import com.example.mygooglemapsactivityfromheck.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        val buffalo = LatLng(42.880230, -78.878738)
        mMap.addMarker(MarkerOptions().position(buffalo).title("Marker in Buffalo"))
    ...
    private fun showPermissionRationale(positiveAction: () -> Unit) {
        ...
        AlertDialog.Builder(this)
            ...
            .setPositiveButton("OK") { _, _ -> positiveAction() }.create().show()
